...
class PsbEvents
{
     ...
     * @var int|null
     *
     * @ORM\Column(name="do_person", type="integer", nullable=true)
     */
    private $doPerson;
     ...
     * @return int|null
     */
    public function getDoPerson(): ?int
    {
        return $this->doPerson;
    }

    /**
     * @param int|null $doPerson
     */
    public function setDoPerson(?int $doPerson): void
    {
